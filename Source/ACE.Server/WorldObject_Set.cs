...
namespace ACE.Server.WorldObjects
{
    partial class WorldObject
    {
        ...
        public long AddItemXP(long amount)
        {
            ...
            long valueOrDefault = ItemTotalXp.GetValueOrDefault();
            long num = valueOrDefault;
            valueOrDefault += amount;
            long num2 = (long)ExperienceSystem.ItemLevelToTotalXP(ItemMaxLevel.Value, (ulong)ItemBaseXp.Value, ItemMaxLevel.Value, ItemXpStyle.Value);
